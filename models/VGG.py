...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=1000, init_weights=True,Embed_dim=512):
        ...
        self.feat = nn.Linear(4096, self.num_features)
        init.kaiming_normal(self.feat.weight, mode='fan_out')
        init.constant(self.feat.bias, 0)

        self.Embed = Embedding(4096, self.num_features)
